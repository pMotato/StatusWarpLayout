...
public class MyOtherView implements IStatusView {
    private View view;
    @Override
    public boolean initView(Context context) {
        ...
        TextView.class.cast(view.findViewById(R.id.title)).setText("this is custom others page");
        TextView.class.cast(view.findViewById(R.id.content)).setText("others");
        return false;
    }
